...
hyperParameters.unloadingFitRange       = 1400;%1400;
hyperParameters.unloadingFitFunction    = 'Oliver-Pharr';%'Feng';
hyperParameters.compensateCreep         = 0; % 1;
hyperParameters.constrainHead = 0;
hyperParameters.constrainTail = 0;


compliance.targetDir = 'C:\Users\augus\Downloads\AFM Compliance\test1\'
compliance.areaFile = 'C:\Users\augus\Downloads\AFM Compliance\calib_0000_arfun.txt'
compliance.springConstant = 202.11;
compliance.Er = 3;
[complianceTot, areaSave] = extractMachineCompliance(compliance,ctrl,hyperParameters);


% Cf = complianceTot - sqrt(2)/pi./(compliance.Er*1e9)*1.*areaSave; % wronf
...
% indentationSet = importGMAMeasurements()
% indentationSet = importTransverseAndLongitudinalFromSheet()
% 
% selIdx = [indentationSet.relativeHumidity] == 45;
% indentationSet = indentationSet(selIdx);
% numel(indentationSet)

% indentationSet = importTransverseFromSheetOnly()
% indentationSet = importFromSheet()
% 
% indentationSet = importLongitudinalFreeOnly()
% clear indentationSet
% indentationSet(1).designatedName        = 'trans_hemi_60';
% indentationSet(1).relativeHumidity      = 60;
% indentationSet(1).indenterType          = 'hemispherical';
% indentationSet(1).indentationNormal     = 'T';
% indentationSet(1).springConstant        = 201.03;
% indentationSet(1).areaFile              = 'C:\Users\augus\Desktop\tempCaterina\Transverse_sheet\60 % RH\calib_0000_arfun.txt';
% indentationSet(1).targetDir             = 'C:\Users\augus\Desktop\tempCaterina\Transverse_sheet\60 % RH\210317\';
% indentationSet(1).thermalHoldTime       = 30; % seconds

% indentationSet(1).designatedName        = 'trans_hemi_60';
% indentationSet(1).relativeHumidity      = 75;
% indentationSet(1).indenterType          = 'hemispherical';
% indentationSet(1).indentationNormal     = 'T';
% indentationSet(1).springConstant        = 201.03;
% indentationSet(1).areaFile              = 'C:\Users\augus\Desktop\tempCaterina\Transverse_sheet\75 % RH\calib_0000_arfun.txt';
% indentationSet(1).targetDir             = 'C:\Users\augus\Desktop\tempCaterina\Transverse_sheet\75 % RH\210317\';
% indentationSet(1).thermalHoldTime       = 10; % seconds
...
sel1 = [results.relativeHumidity] == 45;
sel2 = [results.relativeHumidity] == 47;
