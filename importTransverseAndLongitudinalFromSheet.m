function indentationSet = importTransverseAndLongitudinalFromSheet()
...
% indentationSet(16).designatedName        = 'trans_hemi_45';
% indentationSet(16).relativeHumidity      = 45;
% indentationSet(16).indenterType          = 'hemispherical';
% indentationSet(16).indentationNormal     = 'T';
% indentationSet(16).springConstant        = 268.15;
% indentationSet(16).areaFile              = 'C:\Users\augus\Desktop\tempCaterina\afmRepository\trans_hemi_k_268.15_RH45\LRH250_03_0002_arfun.txt';
% indentationSet(16).targetDir             = 'C:\Users\augus\Desktop\tempCaterina\afmRepository\trans_hemi_k_268.15_RH45\RH45\';
% 
% 
...
% indentationSet(17).springConstant        = 288.25;
% indentationSet(17).areaFile              = 'C:\Users\augus\Desktop\tempCaterina\afmRepository\trans_hemi_k_288.25_RH45\LRH250_4th_5_0001_arfun.txt';
% indentationSet(17).targetDir             = 'C:\Users\augus\Desktop\tempCaterina\afmRepository\trans_hemi_k_288.25_RH45\RH45\';
% 
% indentationSet(18).designatedName        = 'trans_hemi_45';
% indentationSet(18).relativeHumidity      = 45;
% indentationSet(18).indenterType          = 'hemispherical';
% indentationSet(18).indentationNormal     = 'T';
% indentationSet(18).springConstant        = 319.23;
% indentationSet(18).areaFile              = 'C:\Users\augus\Desktop\tempCaterina\afmRepository\trans_hemi_k_319.23_RH45\LRH250_05_0000_arfun.txt';
% indentationSet(18).targetDir             = 'C:\Users\augus\Desktop\tempCaterina\afmRepository\trans_hemi_k_319.23_RH45\RH45\';


indentationSet(16).designatedName        = 'trans_hemi_47';
indentationSet(16).relativeHumidity      = 45;
indentationSet(16).indenterType          = 'hemispherical';
indentationSet(16).indentationNormal     = 'T';
indentationSet(16).springConstant        = 233.8;
indentationSet(16).areaFile              = 'C:\Users\augus\Desktop\tempCaterina\Transverse_sheet\calib_LRCH_05_0001_arfun.txt';
indentationSet(16).targetDir             = 'C:\Users\augus\Desktop\tempCaterina\Transverse_sheet\210126\';
indentationSet(16).thermalHoldTime       = 10; % seconds

indentationSet(17).designatedName        = 'trans_hemi_47';
indentationSet(17).relativeHumidity      = 45;
indentationSet(17).indenterType          = 'hemispherical';
indentationSet(17).indentationNormal     = 'T';
indentationSet(17).springConstant        = 310.21;
indentationSet(17).areaFile              = 'C:\Users\augus\Desktop\tempCaterina\Transverse_sheet\calib_LRCH_05_0001_arfun.txt';
indentationSet(17).targetDir             = 'C:\Users\augus\Desktop\tempCaterina\Transverse_sheet\210127\';
indentationSet(17).thermalHoldTime       = 30; % seconds


indentationSet(18).designatedName        = 'trans_hemi_47';
indentationSet(18).relativeHumidity      = 45;
indentationSet(18).indenterType          = 'hemispherical';
indentationSet(18).indentationNormal     = 'T';
indentationSet(18).springConstant        = 310.21;
indentationSet(18).areaFile              = 'C:\Users\augus\Desktop\tempCaterina\Transverse_sheet\calib_LRCH_05_0001_arfun.txt';
indentationSet(18).targetDir             = 'C:\Users\augus\Desktop\tempCaterina\Transverse_sheet\210128\';
indentationSet(18).thermalHoldTime       = 30; % seconds


indentationSet(19).designatedName        = 'trans_hemi_47';
indentationSet(19).relativeHumidity      = 60;
indentationSet(19).indenterType          = 'hemispherical';
indentationSet(19).indentationNormal     = 'T';
indentationSet(19).springConstant        = 310.21;
indentationSet(19).areaFile              = 'C:\Users\augus\Desktop\tempCaterina\Transverse_sheet\60 % RH\calib_0000_arfun.txt';
indentationSet(19).targetDir             = 'C:\Users\augus\Desktop\tempCaterina\Transverse_sheet\60 % RH\210317\';
indentationSet(19).thermalHoldTime       = 30; % seconds
